...
SOURCES = \
	__init__.py \
	sentinel_stac_loader.py sentinel_stac_loader_dialog.py

PLUGINNAME = sentinel_stac_loader

PY_FILES = \
	__init__.py \
	sentinel_stac_loader.py sentinel_stac_loader_dialog.py

UI_FILES = sentinel_stac_loader_dialog_base.ui
...
QGISDIR=/home/vagner/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
